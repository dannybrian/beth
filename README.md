...
*What this harness does not do:* Ensure code quality, care about best practices, or, well, write good code, per se. Beth couldn't really care less how anything happens under the hood. Implementation, TDD, debugging, coding guidelines are not things provided here; those exist in your repo. Beth can help you build that all out, but won't do it for you. Beth is not a builder; it is a *director* in the [builder pattern](https://refactoring.guru/design-patterns/builder). *And totally and completely unnecessary to that pattern, I might add!* Beth is not needed, no project will depend on her; in fact, they don't like her very much. But she knows how to sequence, how to manage agents effectively, and is able to carry a higher level context and reasoning *on behalf of those she manages, so they don't need to*. In other words, it's a question of scale, and a scale I don't think many projects achieve, or require.
